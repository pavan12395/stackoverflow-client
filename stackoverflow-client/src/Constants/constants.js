...
export const WEB_SOCKET_END_POINT = window._env_.REACT_APP_WEB_SOCKET_END_POINT || 'http://localhost:4000';
...
export const GRPC_SERVER_END_POINT = window._env_.REACT_APP_ENVOY_END_POINT || "http://localhost:9090";
