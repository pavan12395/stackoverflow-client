...
console.log("REACT_APP_WEB_SOCKET_END_POINT : "+window._env_.REACT_APP_WEB_SOCKET_END_POINT)
console.log("REACT_APP_ENVOY_END_POINT : "+window._env_.REACT_APP_ENVOY_END_POINT)
